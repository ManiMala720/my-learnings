...
A collection of small projects and UI components created while learning **HTML** and **CSS**. Each project focuses on a specific concept, animation, or user interface element.
